...
labels = [
    ...
    Label(  'terrain'              , 22 ,        7 , 'nature'          , 4       , False        , True        , (152,251,152) ),
    ...
    Label(  'motorcycle'           , 32 ,       11, 'vehicle'         , 7       , True         , False        , (  0,  0,230) ),
    Label(  'bicycle'              , 33 ,       12 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
