...
import mmcv
import numpy as np
from cityscapesscripts.preparation.json2labelImg12 import json2labelImg
...
def main():
    args = parse_args()
    cityscapes_path = cityscapes_path ='/data/dragoon0905/datasets/UniDA_pascal2cs_12/CityScapes'
