...
class PascalContextDataset(CustomDataset):
    ...
    CLASSES = ('road', 'sidewalk', 'building', 'wall', 'fence', 'pole',
            ...
            'unknown', 'cow', 'cup', 'curtain', 'dog', 'door', 'fence',
            'floor', 'flower', 'food', 'grass', 'ground', 'horse',
            'keyboard', 'light', 'motorbike', 'mountain', 'mouse', 'person',
            'plate', 'platform', 'pottedplant', 'road', 'rock', 'sheep',
            'shelves', 'sidewalk', 'sign', 'sky', 'snow', 'sofa', 'table',
    ...
    PALETTE = [[128, 64, 128], [244, 35, 232], [70, 70, 70], [102, 102, 156],
               ...
               [0, 235, 255], [0, 173, 255], [31, 0, 255], [220, 20, 60]]
    
    gtPALETTE = [[128, 64, 128], [244, 35, 232], [70, 70, 70], [102, 102, 156],
               [190, 153, 153], [153, 153, 153], [250, 170, 30], [220, 220, 0],
               [107, 142, 35], [152, 251, 152], [70, 130, 180],
               [255, 0, 0], [0, 0, 142], [0, 0, 70], [0, 60, 100],
               [0, 80, 100], [0, 0, 230], [119, 11, 32], [255, 255, 255],
...
class PascalContextDataset59(CustomDataset):
    ...
    CLASSES = ('aeroplane', 'bag', 'bed', 'bedclothes', 'bench', 
...
@DATASETS.register_module()
class PascalContextDataset33(CustomDataset):
    """PascalContext dataset.
    ...
    CLASSES = ('aeroplane', 'bicycle','bird', 'boat', 'bottle', 
               'building', 'bus','car', 'cat', 'ceiling', 
               'chair',  'cow', 'dog', 'door', 'fence', 'floor', 'flower',
    ...
    def __init__(self, split, **kwargs):
        super(PascalContextDataset33, self).__init__(
            img_suffix='.jpg',
            seg_map_suffix='.png',
            split=split,
            reduce_zero_label=False,
